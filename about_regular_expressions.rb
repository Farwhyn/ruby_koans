...
class AboutRegularExpressions < Neo::Koan
  ...
  #
  # Why?
  # ANS: as many occurrences as possible are matched while still allowing the overall match to succeed.
  ...
  # ANS: Alternation works on entire regexp captures; character classes just work on
  # characters (so one character class will only alternate across a single
  # character)
